...
var TARGET_CSS_FILE = '__ps_tree.css',
    TARGET_JS_FILE = '__ps_tree.js',
    BROWSERIFY_FILE = 'main.js';

var CSS_PATH = './ps_tree/static/css/',
    JS_PATH = './ps_tree/static/js/',
    IMG_PATH = './ps_tree/static/img/',
    FONT_PATH = './ps_tree/static/fonts/';

var TARGET_CSS_PATH = CSS_PATH + TARGET_CSS_FILE,
    TARGET_JS_PATH = JS_PATH + TARGET_JS_FILE;

var CSS_FILES = [
  './ps_tree/static/css/*.css',
  './ps_tree/static/css/**/*.css',
  '!ps_tree/static/css/no-js.css',
  '!ps_tree/static/css/' + TARGET_CSS_FILE
];

var JS_FILES = [
  './ps_tree/static/js/*.js',
  './ps_tree/static/js/**/*.js',
  '!ps_tree/static/js/' + TARGET_JS_FILE,
  '!ps_tree/static/js/vendor/*.js'
];
